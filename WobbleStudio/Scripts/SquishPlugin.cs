...
namespace WobbleStudio
{
    ...
    public class SquishPlugin : MonoBehaviour, VNyanInterface.IButtonClickedHandler
    {
        ...
        void SetupWindow()
        {
            ...
            HookRegionSlider("twistspeed", 0.05f, 3f, (r, v) => r.twistSpeed = v, r => r.twistSpeed);
            HookRegionSlider("twistdamp", 0.02f, 2f, (r, v) => r.twistDamp = v, r => r.twistDamp);
            HookRegionSlider("swayspeed", 0.05f, 3f, (r, v) => r.swaySpeed = v, r => r.swaySpeed);
            HookRegionSlider("swaydamp", 0.02f, 2f, (r, v) => r.swayDamp = v, r => r.swayDamp);
